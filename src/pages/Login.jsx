    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 animate-fade-in-up">
      <div className="glass-panel w-full max-w-md p-8">
        <header className="mb-8 text-center">
          ...
          <p className="text-gray-400 font-mono text-xs uppercase tracking-widest">Identify to continue</p>
        </header>
        ...
        <p className="mt-6 text-center text-gray-400 font-mono text-xs uppercase tracking-widest">
          New operator? <Link to="/register" className="text-[#00FFB2] hover:underline text-glow-mint">Register here</Link>
        </p>
      </div>
    </div>
  );
